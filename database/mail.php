...
if(isset($_POST["submit"]))
{
 ...
 if($error == '')
 {
  ...
  $mail->Username = 'iandevcodes@gmail.com';     //Sets SMTP username put in your emai, account 
  $mail->Password = 'password';     //Sets SMTP password put in your gmail password
  $mail->SMTPSecure = '';       //Sets connection prefix. Options are "", "ssl" or "tls"
  $mail->From = $_POST["email"];     //Sets the From email address for the message
  $mail->FromName = $_POST["name"];    //Sets the From name of the message
  $mail->AddAddress('ird4ba@virginia.edu', 'Ian');//Adds a "To" address
